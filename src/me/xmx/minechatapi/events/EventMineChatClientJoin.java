...
/**
 * Called when a client is found to be using MineChat.
...
public class EventMineChatClientJoin extends MineChatEvent {
	
	private final Player player;
	private final ChatConnection conn;
	
	public EventMineChatClientJoin(final Player player, final ChatConnection conn) {
		this.player = player;
		this.conn = conn;
	}
